...
function Courses() {
  ...
  return (
    <section id="courses" className="py-20 bg-gradient-to-b from-gray-800 to-gray-900">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Explore our diverse range of courses designed to enhance your skills and advance your career.
          </p>
        </motion.div>
