...
import './Home.css'; // Import the same CSS file used in CertificationPage for styling
...
function CoursePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            >
              <div className="glass rounded-xl p-6">
                <h2 className="text-2xl font-bold mb-6 gradient-text">Available Courses</h2>
            ...
            >
              <AnimatePresence mode="wait">
                {selectedCourse && (
                  ...
                  >
                    <h2 className="text-3xl font-bold mb-6 gradient-text">{selectedCourse.title}</h2>
      ...
      <a className="whats-app" href="https://wa.me/+917995847197" target="_blank" rel="noopener noreferrer">
